...
# PVP-DUELL
# ============================================================================
# Der PvP-Modus benutzt einen autoritativen Host-Spielstand. Die relevanten
# Werte werden zentral hier gehalten, damit das Balancing spaeter einfach
# angepasst werden kann.
PVP_MAX_PLAYERS = 2
PVP_START_COUNTDOWN_MS = 3000
PVP_SNAPSHOT_INTERVAL_MS = 50
PVP_INPUT_INTERVAL_MS = 50
PVP_MAX_RESPAWN_DELAY_MS = 1200
PVP_RESPAWN_DELAY_MS = 900
PVP_RESPAWN_INVULNERABILITY_MS = 2000
PVP_PLAYER_TOP_MARGIN = 28
PVP_PLAYER_BOTTOM_MARGIN = 28
PVP_PLAYER_HORIZONTAL_PADDING = 24
PVP_ASTEROID_SPAWN_MIN_Y = 90
PVP_ASTEROID_SPAWN_MAX_Y_RATIO = 0.76
PVP_ASTEROID_PLAYER_SAFE_DISTANCE = 130
PVP_ASTEROID_SPAWN_ATTEMPTS = 80
PVP_ASTEROID_BASE_SPAWN_INTERVAL = 55
PVP_ASTEROID_MIN_SPAWN_INTERVAL = 20
PVP_WORLD_SNAPSHOT_RETENTION_MS = 3000
PVP_PLAYER_SPEED = 12
PVP_LASER_DAMAGE = 1
PVP_TORPEDO_DAMAGE = 2
PVP_HIT_SCORE = 150
PVP_KILL_SCORE = 1000
PVP_MAX_PROJECTILES = 80
PVP_SCORE_LIMIT_MS = 180000  # PunkteKampf-Rundenzeit; wird nicht für Letzter Überlebender verwendet
PVP_DEFAULT_MODE = "last_survivor"
PVP_TRANSITION_WARNING_MS = 500
PVP_EXPLOSION_DURATION_MS = 500
PVP_RESULT_DELAY_MS = 1600

# ============================================================================
# LOKALER PVP-DUELL-MODUS
# ============================================================================
# Diese Belegungen werden ausschließlich von game/pvp_input.py verwendet.
# Andere Spielmodi greifen nicht auf diese Werte zu.
LOCAL_PVP_KEY_BINDINGS = {
    "player1": {
        "left": "K_a",
        "right": "K_d",
        "laser": "K_w",
...
LOCAL_PVP_PLAYER1_NAME = "Spieler 1"
LOCAL_PVP_PLAYER2_NAME = "Spieler 2"
